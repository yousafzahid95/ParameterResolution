...
static ActionItemTemplateDefinition BuildA002IrActionItemTemplate()
{
    ...
    return new ActionItemTemplateDefinition
    {
        ...
        {
            Template = "{0}",
            Params = { "Review and submit Partner Demographic IR for Review" }
        },
        ...
        // SourceSystemKey: RuleName_{EntityId} -> A002IR_{LEM.EntityId}
    ...
    string ruleName)
{
    ...
    var templateUseThird = new ActionItemTemplateDefinition
    {
        ...
        EntityId = new TemplateParam { Template = "{0}", Params = { "[LEM[2].EntityId]" } },
        TaskId = new TemplateParam { Template = "{0}", Params = { "[LEM[2].EntityId]" } },
        SourceSystemKey = new TemplateParam { Template = "A002IR_{0}", Params = { "[LEM[2].EntityId]" } }
    };
